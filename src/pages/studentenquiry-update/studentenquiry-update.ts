...
@IonicPage()
@Component({
  selector: 'studentenquiry-update',
  templateUrl: 'studentenquiry-update.html'
})

export class StudentEnquiryEditPage {
  ...
  constructor(
    ...
    this.form = formBuilder.group({
      ...
      dob: [student.dob, Validators.compose([Validators.required])],
      parent_name: [student.parent_name, Validators.compose([Validators.required])],
