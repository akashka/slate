...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__welcome__ = __webpack_require__(381);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__users_lists_users_lists__ = __webpack_require__(252);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__home_page_home_page__ = __webpack_require__(251);
    ...
    WelcomePage.prototype.signIn = function () {
        ...
        if (!this.form.valid) {
            ...
            this.user.login(this.account).subscribe(function (resp) {
                loading_1.dismiss();
                _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_6__home_page_home_page__["a" /* HomePage */]);
            }, function (err) {
                loading_1.dismiss();
